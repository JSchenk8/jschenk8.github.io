...
export default function ClickBoxes() {
    ...
    return (<section><div className="profile-icons">
          ...
          <div>{copied && <small className="copied-text">Email copied to clipboard</small>}</div></section>)
}
